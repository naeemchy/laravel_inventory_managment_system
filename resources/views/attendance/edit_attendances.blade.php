                    ...
                    <div class="container-fluid">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Update Employees Attendance :{{ $date->att_date }}
                            </div>
                            <div class="card-header">
                                        ...
                                        @csrf   
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    >Present
                                                    <input type="radio" name="attendance[{{ $row->id }}]" value="Absent" required="" <?php if($row->attendance == 'Absent'){echo "checked";}?>>Absent
                                                </td>
