                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><a class="pull-right btn btn-sm btn-success" href="{{ route('all.customer') }}"><i class="fa fa-eye-slash" aria-hidden="true" id="font"></i>All Customers</a><h3 class="text-center font-weight-light my-4">Single Customer Update</h3></div>
                                     @if ($errors->any())
                                    ...
                                    <div class="card-body">
                                        ...
                                        @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if($edit->shopname == NULL)
                                                <input class="form-control py-4" type="text" name ="shopname" value="None" />
                                                @else
                                                <input class="form-control py-4" type="text" name ="shopname" value="{{ $edit->shopname }}"/>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" name ="bank_branch" value="{{ $edit->bank_branch }}"/>
                                            </div>
                                            <div class="form-group">
