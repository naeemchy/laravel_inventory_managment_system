                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><a class="pull-right btn btn-sm btn-success" href="{{ route('all.customer') }}"><i class="fa fa-eye-slash" aria-hidden="true" id="font"></i>All Customers</a><h3 class="text-center font-weight-light my-4">Single Customer view</h3></div>
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" name ="shopname" value="None" readonly="" />
                                                @else
                                                <input class="form-control py-4" type="text" name ="shopname" value="{{ $single->shopname }}" readonly/>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" name ="bank_branch" value="{{ $single->bank_branch }}" readonly/>
                                            </div>
                                            <div class="form-group">
