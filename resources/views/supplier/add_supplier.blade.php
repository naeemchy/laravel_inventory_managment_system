                                    ...
                                    <div class="card-body">
                                        <form action="{{ url('/insert-supplier') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" name ="name" placeholder="Enter Supplier Name" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" name ="shop" placeholder="Enter Shopname" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" name ="branch_name" placeholder="Enter bank Branch" />
                                            </div> 
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">City</label>
                                                <input class="form-control py-4" type="text" name ="city" placeholder="Enter City" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Supplier Type</label>
                                                <select name="type" class="form-control">
												  <option value="Distributor">Distributor</option>
												  <option value="Whoole Seller">Whoole Seller</option>
